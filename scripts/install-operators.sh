...
if [ "$INSTALL_CP4I" = true ] ; then
    ...
    cat $SCRIPT_DIR/resources/operator-group.yaml_template |
      sed "s#{{NAMESPACE}}#$namespace#g;" > $SCRIPT_DIR/resources/operator-group.yaml
    oc apply -f $SCRIPT_DIR/resources/operator-group.yaml
    rm $SCRIPT_DIR/resources/operator-group.yaml
